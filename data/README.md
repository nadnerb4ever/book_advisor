...
| **`discovery/candidates.sqlite`** | SQLite database of discovered candidate books. | Created/updated by **`book-advisor discovery update`** (Google Books or Open Library per `--catalog`). | **`book-advisor discovery list`**. |
